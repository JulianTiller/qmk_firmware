...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        [3] = LAYOUT_split_3x6_3(   DE_CIRC, DE_1,    DE_2,    DE_3,    DE_4,    DE_5,          DE_6,    DE_7,    DE_8,    DE_9,    DE_0,    DE_SS,
                                    ...
                                    KC_LCTL, DE_BSLS, DE_RCBR, DE_RBRC, DE_RPRN, DE_RABK,       KC_NO,   KC_PGDN, KC_PGUP, KC_NO,   DE_PIPE, TO(_SYS),
                                    KC_CAPS, KC_TRNS, KC_LGUI,                                  KC_LGUI, KC_TRNS, MOUSEJIGGLERMACRO
                                ),

        [4] = LAYOUT_split_3x6_3(   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,           KC_NUM, KC_P7, KC_P8, KC_P9, KC_NO, KC_NO,
                                    KC_NO, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_PEQL,         KC_NO,  KC_P4, KC_P5, KC_P6, KC_NO, TO(_QMK),
                                    KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_PDOT, KC_NO,           KC_P0,  KC_P1, KC_P2, KC_P3, KC_NO, TO(_SYS),
                                    KC_NO, KC_NO,   KC_ENT,                                     TG(_NUM),  KC_NO , KC_NO
                                ),

        [5] = LAYOUT_split_3x6_3(   KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,                   KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12,
                                    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,  TO(_NUM),
                                    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                   KC_NO, KC_NO, KC_NO, KC_NO,  KC_NO,  TO(_QMK),
                                    KC_NO, KC_NO, TG(_SYS),                                     TG(_SYS), KC_NO, KC_NO
                                ),

        [6] = LAYOUT_split_3x6_3(   QK_BOOT,    KC_NO,   KC_NO,   KC_NO,   RGB_TOG, BL_BRTG,          DF(_QWERTZ),   KC_NO,   KC_NO,   KC_NO, KC_NO,   QK_BOOT,
                                    RGB_MOD,    RGB_SPI, RGB_VAI, RGB_HUI, RGB_SAI, BL_UP,            DF(_QWERTY),   KC_NO,   KC_NO,   KC_NO, KC_NO,   TO(_SYS),
                                    RGB_RMOD,   RGB_SPD, RGB_VAD, RGB_HUD, RGB_SAD, BL_DOWN,          DF(_COL),      KC_NO,   KC_NO,   KC_NO, KC_NO,   TO(_NUM),
                                    KC_NO,      KC_NO,   TG(_QMK),                                    TG(_QMK),      KC_NO,   KC_NO
                                )
};
